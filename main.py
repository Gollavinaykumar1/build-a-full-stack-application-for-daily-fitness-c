# main.py — Generated by VIA for: Build a full stack application for daily fitness checking with a FastAPI backend, REST APIs, and PostgreSQL database with a React frontend
